...
// this function is not in here!!!!! find it in base.html
{
    ...
    // qq_video
      ...
      if (!vid) {
        ...
        vai.style.display = "block";
        vai.innerHTML = '(腾讯视频无法播放? 请 <a href="https://v.qq.com/x/page/' + vid +'.html" target="_blank" >点击这里</a> 跳转至腾讯站内)';
      }
      src = ""

      // 创建播放器
      var player = new Txplayer({
        containerId: 'videogfw',
        vid: vid,
      ...
      player.on('ready', ()=>{
        console.log('player ready'); // 初始化完成
      })
    }
